                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full bg-slate-800/50 border border-slate-700/50 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
                        />
                    </div>
                    <div className="flex items-center gap-3">
                        <select
                            ...
                            className="bg-slate-800/50 border border-slate-700/50 rounded-xl px-4 py-2.5 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all"
                        >
                            ...
                            <tbody className="divide-y divide-slate-800/50">
                                {filteredOrders.length === 0 ? (
                                    ...
                                    filteredOrders.map((order, i) => {
                                        ...
                                        return (
                                            <tr key={`${order.ref}-${i}`} className="hover:bg-slate-900/50 transition-colors group">
